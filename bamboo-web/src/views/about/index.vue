<template>
  <div>
    <div class="card mb10">
      ...
      <span class="text">
        <el-link href="https://github.com/tobeflyboy/bamboo/bamboo-web" target="_blank" type="primary">bamboo/bamboo-web</el-link>
    ...
    <div class="card mb10">
      ...
      <el-descriptions :column="2" border>
        ...
        <el-descriptions-item label="Github" label-align="left">
          <el-link href="https://github.com/tobeflyboy/bamboo" target="_blank" type="primary"> Github</el-link>
        </el-descriptions-item>
      </el-descriptions>
    </div>
    <div class="card mb10">
