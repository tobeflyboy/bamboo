...
public enum PermissionEnum {
    ...
    private static final List<PermissionDo> INIT_SYS_PERMISSION_LIST = new ArrayList<>();

    private PermissionEnum(String permissionCode, String permissionName, String parentPermissionCode, String url, String icon, Integer hide, Integer lev, Integer sort) {
    ...
    //static {
        //for (PermissionEnum p : PermissionEnum.values()) {
            //PermissionDo per = PermissionDo.builder()
            //        .id(PrimaryKey.getPermissionId())
    ...
    public static List<PermissionDo> getPermissionList() {
