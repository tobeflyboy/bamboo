...
public class AuthManagerRestController {
    ...
    public WrapperResp<List<RouteRecordRawVo>> permissionTree() {
        ...
        List<RouteRecordRawVo> list = sysPermissionService.findPermission();
    ...
    public WrapperResp<Permission> permission(
        ...
        Permission permission = sysPermissionService.getPermission(permissionId);
        WrapperResp<Permission> resp = WrapperResp.success(permission);
    ...
    public WrapperResp<Boolean> permissionSave(@RequestBody Permission sysPermission) {
    ...
    public WrapperResp<List<Role>> roleAllList() {
        log.info("/api/role/all-list");
        WrapperResp<List<Role>> resp = sysRoleService.roleList();
    ...
    public WrapperResp<PageInfo<Role>> roleList(@RequestBody @Valid RoleQuery query) {
        log.info("/api/role/list query={}", JSON.toJSONString(query));
        PageInfo<Role> page = sysRoleService.findRoleByPage(query);
        WrapperResp<PageInfo<Role>> resp = WrapperResp.success(page);
    ...
    public WrapperResp<Boolean> roleSave(@RequestBody Role role) {
    ...
    public WrapperResp<List<RouteRecordRawVo>> rolePermission(
        ...
        List<RouteRecordRawVo> list = sysPermissionService.getPermissionByRoleId(roleId);
        WrapperResp<List<RouteRecordRawVo>> resp = WrapperResp.success(list);
    ...
    public WrapperResp<PageInfo<User>> userList(@RequestBody(required = false) UserQuery query) {
        log.info("/api/user/list query={}", query);
        PageInfo<User> page = sysUserService.findSysUserByPage(query);
        WrapperResp<PageInfo<User>> resp = WrapperResp.success(page);
    ...
    public WrapperResp<User> userDetail(
            @Parameter(name = "userId", description = "用户ID", example = "1")
            @PathVariable("userId") String userId) {
        log.info("/api/user/detail/{}", userId);
        WrapperResp<User> resp = sysUserService.findById(userId);
    ...
    public WrapperResp<Boolean> userAdd(@RequestBody User user) {
        log.info("/api/user/add {}", JSON.toJSONString(user));
        Role role = ObjectUtil.isEmpty(user) || ObjectUtil.isEmpty(user.getRoleId()) ? null : Role.builder().id(user.getRoleId()).build();
    ...
    public WrapperResp<Boolean> userEdit(@RequestBody User user) {
    ...
    public WrapperResp<Boolean> userResetPwd(@RequestBody User user) {
    ...
    public void userExport(HttpServletResponse response, UserQuery query) {
        try {
            log.info("/api/user/export, user={}", JSON.toJSONString(query));
            List<User> list = sysUserService.findAll(query);
