package com.nutcracker.bamboo.interfaces.rest;
...
import com.nutcracker.bamboo.application.service.auth.SysRoleService;
import com.nutcracker.bamboo.application.service.auth.SysUserService;
import com.nutcracker.bamboo.domain.auth.model.SaveRolePermission;
...
public class AuthManagerRestController {
    ...
    public WrapperResp<PageInfo<SysRole>> roleList(@RequestBody @Valid SysRoleQuery query) {
