...
public interface ConfigService extends IService<ConfigDo> {
     ...
     * @return 系统配置分页列表
     */
    IPage<Config> page(ConfigQuery sysConfigPageQuery);
     ...
     * @return 是否保存成功
     */
    boolean save(Config sysConfigForm);
     ...
     * @return 系统配置表单数据
     */
    Config getConfigFormData(Long id);
     ...
     * @return 是否编辑成功
     */
    boolean edit(Long id, Config sysConfigForm);
